...
public class wirteAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * if(db.login(t, c)) { request.setAttribute("title", t);
		 * request.setAttribute("content", c); RequestDispatcher rd =
		 * request.getRequestDispatcher("RefairCheck.jsp"); rd.forward(request,
		 * response); }else {
