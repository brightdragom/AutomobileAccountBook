					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link"
									href="/AutomobileAccountBook/main/housekeepingBook_view.jsp">CarkeepingBook</a>
								<a class="nav-link"
									href="/AutomobileAccountBook/main/RepairList.jsp">RepairingBook</a>
							</nav>
						</div>
		...
		<div id="layoutSidenav_content">
			<main>
				...
				<form action="/AutomobileAccountBook/RepairProgress" method="post"
					...
					<div class="add-list">
						<div class="mb-3">
							<label for="content">정비 및 수리 내용</label> <input type="text"
								class="form-control" name="item.contents"
								value="${ item.contents}">
						</div>
						<div class="mb-3">
							<label for="date">정비 및 수리 날짜</label> <input type="date"
								class="form-control" name="item.doday" value="${ item.doday}">
						</div>
						<div class="mb-3">
							<label for="content">정비 및 수리 사진</label> <input type="file"
								name="uploadFile" class="form-control" id="uploadFile">
						</div>
					</div>
					<div
					...
					<div align="right">
						<input class="btn btnss-primary" type="submit" value="추가">
					</div>
				</form>
			</main>
		</div>
